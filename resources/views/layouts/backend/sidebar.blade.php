		...
		<aside class="app-sidebar sidebar-scroll ">
			...
			<div class="main-sidebar-body circle-animation ">
				...
				<ul class="side-menu circle">
					...
					<li class="slide">
						<a class="side-menu__item" href="index.html"><i class="side-menu__icon ti-desktop"></i><span class="side-menu__label">Dashboard</span></a>
					</li>
					...
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="#"><i class="side-menu__icon ti-email  menu-icons"></i><span class="side-menu__label">Mail</span><span class="badge badge-warning side-badge">5</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
					...
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="#"><i class="side-menu__icon ti-briefcase"></i><span class="side-menu__label">Apps</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
					...
					<li class="slide">
						<a class="side-menu__item" href="icons.html"><i class="side-menu__icon ti-face-smile"></i><span class="side-menu__label">Icons</span></a>
					</li>
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="#"><i class="side-menu__icon ti-map-alt menu-icon"></i><span class="side-menu__label">Maps</span><span class="badge badge-pink side-badge">2</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
					...
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="#"><i class="side-menu__icon ti-layout menu-icon"></i><span class="side-menu__label">Tables</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
					...
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="#"><i class="side-menu__icon ti-server"></i><span class="side-menu__label">Elements</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
					...
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="#"><i class="side-menu__icon ti-palette "></i><span class="side-menu__label">Advanced UI</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
					...
					<li class="slide ">
						<a class="side-menu__item" data-toggle="slide" href="#"><i class="side-menu__icon ti-view-grid"></i><span class="side-menu__label">Submenus</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
							<li class="sub-slide">
								<a class="slide-item" data-toggle="sub-slide" href="#"><span class="sub-side-menu__label">Level1</span></a>
							</li>
							<li class="sub-slide">
								<a class="slide-item" data-toggle="sub-slide" href="#"><span class="sub-side-menu__label">Level2</span><i class="sub-angle fe fe-chevron-down"></i></a>
								<ul class="sub-slide-menu">
									<a class="sub-side-menu__item" data-toggle="sub-slide" href="#"><span class="sub-side-menu__label">Level1.1</span><i class="sub-angle2 fe fe-chevron-up"></i></a>
										<ul class="sub-slide-menu">
											<li><a class="sub-slide-item2" href="#">Level-2.1</a></li>
											<li><a class="sub-slide-item2" href="#">Level-2.2</a></li>
										</ul>
									<li><a class="sub-side-menu__item" href="#">Level1.2</a></li>
									<li><a class="sub-side-menu__item" href="#">Level1.3</a></li>
								</ul>
							</li>
						</ul>
					</li>
